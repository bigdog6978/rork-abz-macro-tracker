import { DayPlan, MacroStrategy, DietaryModifier, MacroTargets, MeasurementSystem } from '../types';
...
export function getMealPlanForStrategy(
  ...
  return generateMealPlan(targets, strategy, modifiers, measurementSystem);
}
