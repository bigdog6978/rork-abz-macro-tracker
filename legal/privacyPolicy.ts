export const PRIVACY_POLICY_LAST_UPDATED = 'March 04, 2026';

export const PRIVACY_POLICY = `Privacy Policy for Physiq: Macro Tracker
...
Application refers to Physiq: Macro Tracker, the software program provided by the Company.

Company (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Physiq: Macro Tracker.
