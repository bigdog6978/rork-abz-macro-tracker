...
export const FOODS: Record<string, FoodItemData> = {
  chicken_breast: f('chicken_breast', 'Grilled chicken breast', 165, 31, 0, 3.6, 170, 28.35, 'oz', ['meat', 'animal']),
  salmon: f('salmon', 'Salmon fillet', 208, 20, 0, 13, 140, 28.35, 'oz', ['fish', 'animal']),
  ground_beef_90: f('ground_beef_90', 'Lean ground beef', 217, 27, 0, 11, 170, 28.35, 'oz', ['meat', 'animal']),
  eggs: f('eggs', 'Eggs', 155, 13, 1.1, 11, 150, 50, 'large egg', ['egg', 'animal']),
  turkey_breast: f('turkey_breast', 'Turkey breast', 135, 30, 0, 1, 170, 28.35, 'oz', ['meat', 'animal']),
  shrimp: f('shrimp', 'Shrimp', 99, 24, 0.2, 0.3, 140, 28.35, 'oz', ['fish', 'animal']),
  ribeye: f('ribeye', 'Ribeye steak', 271, 24, 0, 19, 225, 28.35, 'oz', ['meat', 'animal']),
  pork_loin: f('pork_loin', 'Pork tenderloin', 143, 27, 0, 3.5, 170, 28.35, 'oz', ['meat', 'animal']),
  tuna_canned: f('tuna_canned', 'Tuna (canned in water)', 116, 26, 0, 0.8, 140, 28.35, 'oz', ['fish', 'animal']),
  cod: f('cod', 'Baked cod', 105, 23, 0, 0.9, 170, 28.35, 'oz', ['fish', 'animal']),
  bacon: f('bacon', 'Bacon', 541, 37, 1.4, 42, 42, 14, 'strip', ['meat', 'animal']),
  ...
  ground_beef_80: f('ground_beef_80', 'Ground beef patty', 254, 26, 0, 17, 225, 28.35, 'oz', ['meat', 'animal']),
  ...
  butter: f('butter', 'Butter', 717, 0.9, 0.1, 81, 14, 14, 'tbsp', ['dairy', 'animal']),
  ...
  avocado: f('avocado', 'Avocado', 160, 2, 9, 15, 68, 68, 'half', ['fat', 'plant']),
  almonds: f('almonds', 'Almonds', 579, 21, 22, 50, 28, 28, 'oz (23 almonds)', ['nut', 'plant']),
  walnuts: f('walnuts', 'Walnuts', 654, 15, 14, 65, 28, 28, 'oz', ['nut', 'plant']),
  macadamia: f('macadamia', 'Macadamia nuts', 718, 8, 14, 76, 28, 28, 'oz', ['nut', 'plant']),
  peanut_butter: f('peanut_butter', 'Peanut butter', 588, 25, 20, 50, 32, 16, 'tbsp', ['nut', 'plant', 'legume']),
  almond_butter: f('almond_butter', 'Almond butter', 614, 21, 19, 56, 32, 16, 'tbsp', ['nut', 'plant']),
  olive_oil: f('olive_oil', 'Olive oil', 884, 0, 0, 100, 14, 14, 'tbsp', ['fat', 'plant']),
  coconut_oil: f('coconut_oil', 'Coconut oil', 862, 0, 0, 100, 14, 14, 'tbsp', ['fat', 'plant']),
  mixed_nuts: f('mixed_nuts', 'Mixed nuts', 607, 20, 21, 54, 28, 28, 'oz', ['nut', 'plant']),
  trail_mix: f('trail_mix', 'Trail mix', 462, 14, 44, 29, 40, 28, 'oz', ['nut', 'plant']),
  ...
  pork_rinds: f('pork_rinds', 'Pork rinds', 544, 61, 0, 31, 28, 28, 'oz', ['meat', 'animal']),
